...
class ClosedownServiceTestCase(unittest.TestCase):
    @classmethod
    def setUpClass(self):
        self.closedownService = ClosedownService(
    ...
    def test_getChrgInfo(self):
        chrgInfo = self.closedownService.getChargeInfo(
    ...
    def test_getPopbillURL(self):
        url = self.closedownService.getPopbillURL(
    ...
    def test_checkCorpNum(self):
        ...
        self.assertEqual(
            result.corpNum,
            "4010394930",
            "checkCorpNum 오류 :" + str(result.message),
        )

    def test_checkCorpNums(self):
        resultList = self.closedownService.checkCorpNums(
            self.testCorpNum, ["1234567890", "4108600477", "410-86-21884"]
        )
