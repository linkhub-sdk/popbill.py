...
class MessageServiceTestCase(unittest.TestCase):
    ...
    def test_getChargeInfo(self):
        chrgInfo = self.messageService.getChargeInfo(
            self.testCorpNum, "MMS", self.testUserID
        )
    ...
    def test_getAutoDenyList(self):
        autoDenyList = self.messageService.getAutoDenyList(
    ...
    def test_checkSenderNumber(self):
        try:
            SenderNumber = ""
            response = self.messageService.checkSenderNumber(
    ...
    def test_getMessage(self):
        ...
        info = self.messageService.search(
            self.testCorpNum,
            SDate,
            EDate,
            State,
    ...
    def test_06_sendSMS_one(self):
        try:
            receiptNum = self.messageService.sendSMS(
                self.testCorpNum,
                "",
                "",
                "수신자명",
    ...
    def test_07_sendSMS(self):
        ...
        receiptNum = self.messageService.sendSMS_multi(
            self.testCorpNum,
            "",
            "동보전송 메시지 내용",
            messages,
    ...
    def test_09__sendLMS_one(self):
        reserveDT = ""
        try:
            receiptNum = self.messageService.sendLMS(
                self.testCorpNum,
                "",
                "",
                "수신자명",
    ...
    def test_10_sendLMS(self):
        ...
        receiptNum = self.messageService.sendLMS_multi(
            self.testCorpNum,
            "",
            "Subject",
            "동보전송 메시지 내용",
    ...
    def test_11__sendXMS_one(self):
        ...
        try:
            receiptNum = self.messageService.sendXMS(
                self.testCorpNum,
                "",
                "",
                "수신자명",
    ...
    def test_12_sendXMSnResult(self):
        ...
        receiptNum = self.messageService.sendXMS_multi(
            self.testCorpNum,
            "",
            Subject,
            "동보전송 메시지 내용",
    ...
    def test_15_sendMMS(self):
        ...
        try:
            receiptNum = self.messageService.sendMMS(
                self.testCorpNum,
                "",
                "",
                "수신자명",
    ...
    def test_16_sendMMS(self):
        ...
        try:
            receiptNum = self.messageService.sendMMS_Multi(
                self.testCorpNum,
                "",
                "",
                "",
    ...
    def test_getSenderNumberList(self):
        numberList = self.messageService.getSenderNumberList(
            self.testCorpNum, self.testUserID
        )
    ...
    def test_getStates(self):
        ...
        response = self.messageService.getStates(
            self.testCorpNum, receiptNumList, "testkorea"
        )
        print(len(response))
    ...
    def test_cancelReservebyRCV(self):
        try:
            ...
            respone = self.messageService.cancelReservebyRCV(
    ...
    def test_cancelReserveRNbyRCV(self):
        try:
            requestNum = "20180809144427"
            receiveNum = "0102223333"
            respone = self.messageService.cancelReserveRNbyRCV(
    ...
    def test_getSenderNumberMgtURL(self):
        try:
            response = self.messageService.getSenderNumberMgtURL(
                self.testCorpNum, self.testUserID
            )
            print(response)
        except PopbillException as PE:
    ...
    def test_getSentListURL(self):
        try:
            response = self.messageService.getSentListURL(
                self.testCorpNum, self.testUserID
            )
            print(response)
        except PopbillException as PE:
    ...
    def test_checkAutoDenyNumber(self):
        ...
        self.assertTrue(("smsdenyNumber" in keys) and ("regDT" in keys))
