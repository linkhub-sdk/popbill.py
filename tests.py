...
class TaxinvoiceServiceTestCase(unittest.TestCase):
    @classmethod
    def setUpClass(self):
        self.taxinvoiceService = TaxinvoiceService(
    ...
    #     try:
    #         TaxinvoiceXML = self.taxinvoiceService.getXML(
    #             self.testCorpNum, "SELL", "1234"
    #         )
    ...
    #     try:
    #         TaxinvoiceCertificate = self.taxinvoiceService.getTaxCertInfo(
    #             self.testCorpNum
    #         )
    ...
    #     info = self.taxinvoiceService.getDetailInfoByItemKey(
    #         self.testCorpNum, "022071418252400001"
    #     )
    #     print(info.detailList)
    #
    # def test_attachStmt(self):
    #     try:
    #         response = self.taxinvoiceService.attachStatement(
    #             self.testCorpNum,
    #             "SELL",
    #             "chzovl6d5u",
    #             "121",
    ...
    #     response = self.taxinvoiceService.detachStatement(
    #         self.testCorpNum, "SELL", "chzovl6d5u", "121", "fbrdavxpsn", self.testUserID
    #     )
    #     print(response.message)
    #
    # def test_1_registIssue(self):
    #     taxinvoice = Taxinvoice(
    #         writeDate="20190227",  # 작성일자
    #         chargeDirection="정과금",
    #         issueType="정발행",
    #         purposeType="영수",
    #         issueTiming="직접발행",
    ...
    #                 remark="품목비고",
    #             ),
    #             TaxinvoiceDetail(serialNum=2, itemName="품목2"),
    #         ],
    #         addContactList=[
    #             Contact(serialNum=1, contactName="추가담당자 성명", email=""),
    #             Contact(serialNum=2, contactName="추가담당자2", email=""),
    #         ],
    #     )
    #
    ...
    #
    #     result = self.taxinvoiceService.registIssue(
    #         self.testCorpNum,
    #         taxinvoice,
    #         writeSpecification,
    #         forceIssue,
    ...
    #     InterOPYN = ""
    #
    #     response = self.taxinvoiceService.search(
    #         self.testCorpNum,
    #         MgtKeyType,
    #         DType,
    #         SDate,
    ...
    #     infos = self.taxinvoiceService.getInfos(
    #         self.testCorpNum, "SELL", ["1234", "1234567890"]
    #     )
    ...
    #     targetUserID = "testkorea20250804_01"
    #
    #     response = self.taxinvoiceService.deleteContact(
    #         self.testCorpNum, targetUserID, self.testUserID
    #     )
    #     print(response.message)
    #
    # def test_registContact(self):
    #     contactInfo = ContactInfo(
    #         id="testkorea20250804_01",
    #         pwd="popbill!2",
    #         personName="test",
    #         tel="010-1234-1234",
    #         hp="010-1234-1234",
    ...
    #         searchRole=3
    #     )
    #     response = self.taxinvoiceService.registContact(
    ...
    #         bizClass="업종_0725",
    #     )
    #     response = self.taxinvoiceService.updateCorpInfo(
    ...
    #     chrgInfo = self.taxinvoiceService.getChargeInfo(
    ...
    #         mgtYN=False,
    #     )
    #     response = self.taxinvoiceService.updateContact(
    #         self.testCorpNum, contactInfo, self.testUserID
    #     )
    #     print(response.message)
    #
    ...
    #     url = self.taxinvoiceService.getPopbillURL(
    #         self.testCorpNum, self.testUserID, "CERT"
    #     )
    #     print(url)
    ...
    #     )
    #     self.assertRaises(
    #         PopbillException, self.taxinvoiceService.joinMember, newMember
    #     )
    #
    ...
    #     bIsInUse = self.taxinvoiceService.checkMgtKeyInUse(
    #         self.testCorpNum, "SELL", "1234"
    #     )
    #     self.assertEqual(bIsInUse, True, "등록으로 확인")
    #
    #     bIsInUse = self.taxinvoiceService.checkMgtKeyInUse(
    #         self.testCorpNum, "SELL", "12345678901"
    #     )
    #     self.assertEqual(bIsInUse, False, "미등록으로 확인")
    #
    # def test_1_register(self):
    #     taxinvoice = Taxinvoice(
    #         writeDate="20150121",  # 작성일자
    #         chargeDirection="정과금",
    #         issueType="정발행",
    #         purposeType="영수",
    #         issueTiming="직접발행",
    ...
    #         ],
    #         addContactList=[
    #             Contact(serialNum=1, contactName="추가담당자 성명", email="test1@test.com"),
    #             Contact(serialNum=2, contactName="추가담당자2", email="test2@test.com"),
    #         ],
    #     )
    #
    #     result = self.taxinvoiceService.update(
    #         self.testCorpNum, "SELL", self.testMgtKey, taxinvoice
    #     )
    #     self.assertEqual(result.code, 1, "수정 오류 : " + result.message)
    #
    # def test_attachFile(self):
    #     result = self.taxinvoiceService.attachFile(
    #         self.testCorpNum, "SELL", self.testMgtKey, "test.jpeg"
    #     )
    ...
    #     info = self.taxinvoiceService.getDetailInfo(
    #         self.testCorpNum, "SELL", "123456789012"
    #     )
    ...
    #     result = self.taxinvoiceService.delete(
    #         self.testCorpNum, "SELL", self.testMgtKey
    #     )
    ...
    #     response = self.taxinvoiceService.assignMgtKey(
    #         self.testCorpNum, "SELL", "", "20180903-003", self.testUserID
    #     )
    #     print(response.code)
    #     print(response.message)
    #
    ...
    #
    #     try:
    #         result = self.taxinvoiceService.updateEmailConfig(
    ...
    #     response = self.taxinvoiceService.checkCertValidation(
    #         self.testCorpNum, self.testUserID
    #     )
    #
    #     print(response.code)
    ...
    #     response = self.taxinvoiceService.getAccessURL(
    #         self.testCorpNum, self.testUserID
    #     )
    #     print(response)
    #
    # def test_getChargeURL(self):
    #     response = self.taxinvoiceService.getChargeURL(
    #         self.testCorpNum, self.testUserID
    #     )
    #     print(response)
    #
    ...
    #     response = self.taxinvoiceService.getTaxCertURL(
    #         self.testCorpNum, self.testUserID
    #     )
    #     print(response)
    #
    ...
    #     MgtKeyType = "SELL"
    #     MgtKey = "20190227-001"
    #     response = self.taxinvoiceService.getViewURL(
    #         self.testCorpNum, MgtKeyType, MgtKey, self.testUserID
    #     )
    #     print(response)
    #
    ...
    #     MgtKey = "20190227-001"
    #     try:
    #         response = self.taxinvoiceService.getPDFURL(
    #             self.testCorpNum, MgtKeyType, MgtKey, self.testUserID
    #         )
