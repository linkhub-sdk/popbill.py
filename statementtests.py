...
class StatementServiceTestCase(unittest.TestCase):
    ...
    #     ItemCode = "126"
    #     chrgInfo = self.statementService.getChargeInfo(
    #         self.testCorpNum, ItemCode, self.testUserID)
    ...
    #     response = self.statementService.attachStatement(self.testCorpNum, ItemCode, MgtKey, SubItemCode, SubMgtKey,
    #                                                      self.testUserID)
    ...
    #     SubItemCode = "121"
    #     SubMgtKey = "fbrdavxpsn"
    #     response = self.statementService.detachStatement(self.testCorpNum, ItemCode, MgtKey, SubItemCode, SubMgtKey,
    #                                                      self.testUserID)
    #     print(response.message)
    ...
    #     response = self.statementService.search(self.testCorpNum, DType, SDate, EDate, State, ItemCode, Page, PerPage,
    ...
    #     result = self.statementService.FAXSend(
    #         self.testCorpNum, statement, SendNum, ReceiveNum, self.testUserID)
    #     print(result)
    ...
    #     Memo = "즉시발행 메모"
    #     EmailSubject = ""
    #     result = self.statementService.registIssue(
    #         self.testCorpNum, statement, Memo, self.testUserID, EmailSubject)
    #     print(result.message)

    # def test_getInfos(self):
    #     infos = self.statementService.getInfos(
    #         self.testCorpNum, 121, ["20150707-01", "20150706-01"])
    #     for info in infos:
    ...
    #     url = self.statementService.getPopbillURL(
    ...
    #     url = self.statementService.getURL(
    #         self.testCorpNum, self.testUserID, "TBOX")
    #     print("TBOX URL = " + url)
    #     self.assertEqual(url[:5], "https", "https로 시작")
    ...
    #     bIsInUse = self.statementService.checkMgtKeyInUse(
    #         self.testCorpNum, 121, "20150319-10")
    #     self.assertEqual(bIsInUse, True, "등록으로 확인")

    #     bIsInUse = self.statementService.checkMgtKeyInUse(
    #         self.testCorpNum, 121, "20150323-10")
    ...
    #     result = self.statementService.update(
    #         self.testCorpNum, 121, "20150325-01", statement)
    #     self.assertEqual(result.code, 1, "등록 오류 : " + result.message)

    # def test_03_issue(self):
    #     result = self.statementService.issue(
    #         self.testCorpNum, 121, "20150325-01", "발행메모")
    #     self.assertEqual(result.code, 1, "발행 오류: " + result.message)

    # def test_04_cancel(self):
    #     result = self.statementService.cancel(
    #         self.testCorpNum, 121, "20150325-01", "취소메모")
    #     self.assertEqual(result.code, 1, "발행취소 오류 : " + result.message)

    # def test_05_getInfo(self):
    #     result = self.statementService.getInfo(
    #         self.testCorpNum, 121, "20150325-01")
    #     print(result.itemCode)
    #     self.assertEqual(result.itemCode, 121,
    #                      "getInfo오류 :" + str(result.message))

    # def test_06_getDetailInfo(self):
    #     result = self.statementService.getDetailInfo(
    #         self.testCorpNum, 121, "20150325-01")
    #     print(result.propertyBag.Balance)
    #     self.assertEqual(result.mgtKey, "20150325-01",
    #                      "getDetail오류 :" + str(result.message))

    # def test_07_sendEmail(self):

    #     result = self.statementService.sendEmail(
    #         self.testCorpNum, 121, "20150325-01", "")
    ...
    #     result = self.statementService.sendFAX(
    #         self.testCorpNum, 121, "20150325-01", "", "")
    #     self.assertEqual(result.code, 1, "알림문자 전송 오류 : " + result.message)

    # def test_10_getLogs(self):
    #     result = self.statementService.getLogs(
    #         self.testCorpNum, 121, "20150325-01")
    #     print(result[3].procMemo)

    # def test_021_attachFile(self):
    #     result = self.statementService.attachFile(
    #         self.testCorpNum, 121, "20150325-01", "test.jpeg")
    #     self.assertEqual(result.code, 1, "파일 첨부 오류 : " + result.message)

    # def test_022_getFilesAndDelete(self):
    #     result = self.statementService.getFiles(
    #         self.testCorpNum, 121, "20150325-01")
    #     print(result[0].attachedFile)

    #     result2 = self.statementService.deleteFile(
    #         self.testCorpNum, 121, "20150325-01", result[0].attachedFile)
    #     self.assertEqual(result2.code, 1, "첨부파일 삭제오류 : " + result2.message)

    # def test_023_getPopUpURL(self):
    #     url = self.statementService.getPopUpURL(
    #         self.testCorpNum, 121, "20150325-01", self.testUserID)
    #     print("popup url : " + url)
    #     self.assertEqual(url[:5], "https", "https로 시작 ")

    # def test_023_getViewURL(self):
    #     url = self.statementService.getViewURL(
    #         self.testCorpNum, 121, "20150325-01", self.testUserID)
    #     print("view url : " + url)
    #     self.assertEqual(url[:5], "https", "https로 시작 ")

    # def test_024_getPrintURL(self):
    #     url = self.statementService.getPrintURL(
    #         self.testCorpNum, 121, "20150325-01", self.testUserID)
    #     print("print url : " + url)
    #     self.assertEqual(url[:5], "https", "https로 시작 ")

    # def test_025_getEPrintURL(self):
    #     url = self.statementService.getEPrintURL(
    #         self.testCorpNum, 121, "20150325-01", self.testUserID)
    #     print("Eprint url : " + url)
    #     self.assertEqual(url[:5], "https", "https로 시작 ")

    # def test_026_getMailURL(self):
    #     url = self.statementService.getMailURL(
    #         self.testCorpNum, 121, "20150325-01", self.testUserID)
    #     print("Mail url : " + url)
    #     self.assertEqual(url[:5], "https", "https로 시작 ")
    ...
    #     url = self.statementService.getMassPrintURL(
    #         self.testCorpNum, 121, MgtKeyList, self.testUserID)
    #     print("Massprint url : " + url)
    #     self.assertEqual(url[:5], "https", "https로 시작 ")

    # def test_99_delete(self):
    #     result = self.statementService.delete(
    #         self.testCorpNum, 121, "20150325-01")
